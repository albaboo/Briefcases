...
public final class Guerrer extends Personatge {

	/**
	 * Constructor d'un objecte Guerrer amb parametres (stats en array)
	 * <br>
	 * <br>
	 ...
	 */
	public Guerrer(String nom, Tipologia classe, Arma arma, Amulet amulet, Armadura armadura, int[] stats, Habilitat h1, Habilitat h2) {
		super(nom, classe, arma, amulet, armadura, stats, h1, h2);
		setForza(getForza()+2);
		setConstitucio(getConstitucio()+2);
		this.resetSubstats();
	 ...
	 * <br>
	 * <br>
	 * Personatge amb parametres l'objecte Guerrer creat s'emmagatzema a l'arrayList personatges
	 * @param nom          Nom del personatge
	 * @param classe       Classe del personatge
	 ...
	 */
	public Guerrer(String nom, String classe, Arma arma, Amulet amulet, Armadura armadura, int forza, int constitucio, int velocitat, int inteligencia,
