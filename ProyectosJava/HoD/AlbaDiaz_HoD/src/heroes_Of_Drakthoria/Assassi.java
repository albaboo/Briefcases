...
public final class Assassi extends Personatge{

	/**
	 * Constructor d'un objecte Assassi amb parametres (stats en array)
	 * <br>
	 * <br>
	 ...
	 */
	public Assassi(String nom, Tipologia classe, Arma arma, Amulet amulet, Armadura armadura, int[] stats, Habilitat h1, Habilitat h2) {
		super(nom, classe, arma, amulet, armadura, stats, h1, h2);
		setVelocitat(getVelocitat()+3);
		setSort(getSort()+1);
		this.resetSubstats();
	 ...
	 * <br>
	 * <br>
	 * Personatge amb parametres l'objecte Assassi creat s'emmagatzema a l'arrayList personatges
	 * @param nom          Nom del personatge
	 * @param classe       Classe del personatge
	 ...
	 */
	public Assassi(String nom, String classe, Arma arma, Amulet amulet, Armadura armadura, int forza, int constitucio, int velocitat, int inteligencia,
