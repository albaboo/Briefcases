...
public final class Cavaller extends Personatge{
	
	/**
	 * Constructor d'un objecte Cavaller amb parametres (stats en array)
	 * <br>
	 * <br>
	 ...
	 */
	public Cavaller(String nom, Tipologia classe, Arma arma, Amulet amulet, Armadura armadura, int[] stats, Habilitat h1, Habilitat h2) {
	 ...
	 * <br>
	 * <br>
	 * Personatge amb parametres l'objecte Cavaller creat s'emmagatzema a l'arrayList personatges
	 * @param nom          Nom del personatge
	 * @param classe       Classe del personatge
	 ...
	 */
	public Cavaller(String nom, String classe, Arma arma, Amulet amulet, Armadura armadura, int forza, int constitucio, int velocitat, int inteligencia,
